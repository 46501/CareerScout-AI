...
router.post('/register', async (req, res) => {
  try {
    ...
    res.json({ token, user: { _id: user._id, name: user.name, email: user.email, profile: user.profile, profileCompleted: user.profileCompleted, completionPercentage: user.completionPercentage } });
  } catch (err) {
