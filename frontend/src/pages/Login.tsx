...
import { Award, Target, Zap, TrendingUp, Mail, Lock, Eye, EyeOff, ShieldCheck, Sun, Search, BarChart3, Rocket, PlayCircle, Briefcase, ArrowRight, GraduationCap, LineChart, User, Github, Linkedin } from 'lucide-react';
import api from '../api';
